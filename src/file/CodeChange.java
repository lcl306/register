...
public class CodeChange {
	...
	public static void main(String[] args)throws Exception{
		...
		changeDir("C:/daifuku/wms/sqlscript/oracle/3.initdata",
				"C:/daifuku/wms/sqlscript/oracle/3.initdataTemp", ALL_FILE);
	...
	public static void changeDir(String sourceDir, String targetDir, final String fileType)throws Exception{
		changeDir(new File(sourceDir), new File(targetDir), fileType, CN_CODE, STD_CODE);
	}
